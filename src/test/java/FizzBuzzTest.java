...
public class FizzBuzzTest {
    ...
    public void testStartLessThanEnd_HappyPath(){
       ...
       //Создаем объект класса FizzBuzz fizzBuzz = new FizzBuzz();
        //Можем вызывать метод только от референсных, поэтому переводим в референсную
    ...
    //Числа отрицательные expected Result обратно прописать
